...
import { mapAccomodationListFromModelToApi, mapAccomodationFromModelToApi } from "./accomodation.mappers.js";
...
accomodationApi
    ...
    try {
        ...
        const accomodation = await accomodationRepository.getAccomodation(id);
        if (accomodation) {
            const lastId = accomodation.reviews && accomodation.reviews.length > 0
