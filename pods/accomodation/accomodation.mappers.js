...
export const mapAccomodationListFromModelToApi = (accomodationList) => accomodationList.map(mapAccomodationFromModelToApi);
export const mapAccomodationListFromApiToModel = (accomodationList) => accomodationList.map(mapAccomodationFromApiToModel);
// Accomodation mappers
export const mapAccomodationFromModelToApi = (accomodation) => ({
...
export const mapAccomodationFromApiToModel = (accomodation) => ({
...
// Review Mappers
export const mapReviewsFromModelToApi = (reviews) => {
...
export const mapReviewsFromApiToModel = (reviews) => reviews.map(mapReviewFromApiToModel);
